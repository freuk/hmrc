...
define-command zellij-terminal -params 1.. -docstring '
zellij-terminal <program> [<arguments>]: create a new terminal as a zellij pane
The current pane is split into two, top and bottom
The program passed as argument will be executed in the new terminal' \
%{
    zellij-run "--close-on-exit -f" %arg{@}
}
complete-command zellij-terminal shell
